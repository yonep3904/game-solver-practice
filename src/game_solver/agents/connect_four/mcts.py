...
from .engine import ConnectFourEngine, ConnectFourEngineAction, ConnectFourEngineState
...
class MCTSNode:
    def __init__(
        ...
        action: ConnectFourEngineAction | None = None,
    ):
        self.state = state
        self.parent = parent
        self.action = action
        ...
        self.untried_actions: list[ConnectFourEngineAction] = []
...
class ConnectFourMCTSAgent(ConnectFourAgent):
    ...
    def __init__(
        ...
        self._engine = ConnectFourEngine()
    ...
    def _simulate(self, state: ConnectFourEngineState) -> float:
        current = state
